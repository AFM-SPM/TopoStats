...
from topostats.unet_masking import dice_loss, iou_loss, pad_bounding_box, predict_unet, square_bounding_box
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(6, 1, 8, 7, (10, 10), (4, 1, 10, 7), id="constrained bottom"),
        pytest.param(
            117,
            20,
            521,
            ...
            (608, 608),
            (24, 20, 607, 603),
            id="constrained top and bottom",
            marks=pytest.mark.xfail(reason="non-square bounding box returned"),
        ),
        pytest.param(
            1,
            1,
...
def test_make_bounding_box_square(
    ...
    result = square_bounding_box(crop_min_row, crop_min_col, crop_max_row, crop_max_col, image_shape)
