...
def test_process_scan_below(regtest, tmp_path, process_scan_config: dict, load_scan_spm: LoadScans) -> None:
...
def test_process_scan_above(regtest, tmp_path, process_scan_config: dict, load_scan_spm: LoadScans) -> None:
    """Regression test for checking the process_scan functions correctly"""
    load_scan_spm.get_data()
    img_dic = load_scan_spm.img_dict
    _, results = process_scan(
...
def test_process_scan_both(regtest, tmp_path, process_scan_config: dict, load_scan_spm: LoadScans) -> None:
    """Regression test for checking the process_scan functions correctly"""
...
def test_save_cropped_grains(
    tmp_path: Path, process_scan_config: dict, load_scan_spm: LoadScans, image_set, expected
) -> None:
...
def test_save_format(process_scan_config: dict, load_scan_spm: LoadScans, tmp_path: Path, extension: str):
