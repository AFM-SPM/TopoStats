...
def parabola_coordinates(points) -> np.ndarray:
...
@pytest.mark.parametrize(
    "points, edge_order, expected_first_derivative, expected_second_derivative, expected_local_curvature",
    [
        (
            10,
            1,
            ...
            np.asarray(
                [
                    [1.11111111e00, -1.08641975e00],
                    [1.11111111e00, -9.87654321e-02],
...
def test_curvature_parabola(
    ...
    parabola_points = parabola_coordinates(points)
    print(parabola_points)
