    ...
    [
        ...
        pytest.param(
            ...
            run_modules.splining,
            {
                ...
                "method": "spline",
                "window_size": 1.0,
                "rolling_window_resampling": True,
                "rolling_window_resample_regular_spatial_interval": 1.0,
                "step_size": 0.2,
        ...
        pytest.param(
            [
                ...
                "1",
                "--splining-rolling-window-resampling",
                "True",
                "--splining-rolling-window-resample-regular-spatial-interval",
                "1.0",
                "--splining-step-size",
                "0.2",
            ...
            run_modules.process,
            {
                ...
                "splining_rolling_window_resampling": True,
                "splining_rolling_window_resample_regular_spatial_interval": 1.0,
