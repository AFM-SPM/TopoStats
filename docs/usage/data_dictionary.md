...
**Note:** If a field's values are all `None` or `NaN` the field will be omitted from its relevant `.csv`.
...
| `grain_number`              | Id of the grain within the image.                                                                                                                                                                                    | `int`     | N/A    |
| `class`                     | Id of the class within the grain.                                                                                                                                                                                    | `int`     | N/A    |
| `subgrain`                  | Id of the subgrain within the class.                                                                                                                                                                                 | `int`     | N/A    |
| `threshold_idx`             | Index of the threshold used to find the subgrain.                                                                                                                                                                    | `int`     | N/A    |
...
| `num_nodes`                 | The total number of nodes found in the entire grain.                                                                                                                                                                 | `int`     | N/A    |
...
| `mean_end_to_end_distance`  | The average distance from two endpoints of the spline of all identified linear molecules.                                                                                                                            | `float`   | m      |
