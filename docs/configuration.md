...
|                                                      | `threshold_std_dev`                     | dictionary                                         | `10.0, 1.0`                 | A dictionary, with keys `above` and `below` where each of the values is a list of floats indicating the threshold for objects of different class types.                                                                                                                                                                                                                                                                                   |
|                                                      | `threshold_absolute`                    | dictionary                                         | `-1.0, 1.0`                 | A dictionary, with keys `above` and `below` where each of the values is a list of floats indicating the threshold for objects of different class types.                                                                                                                                                                                                                                                                                   |
