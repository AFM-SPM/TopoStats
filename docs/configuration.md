...
|                 | `threshold_absolute`         | dictionary | `-1.0, 1.0`    | Lower (first) and upper (second) absolute threshold for separating data from the image background.                                                                                                                                                           |
...
|                 | `threshold_absolute`         | dictionary | `-1.0, 1.0`    | Lower (first) and upper (second) absolute threshold for separating grains from the image background.                                                                                                                                                         |
