...
|              | `pixel_interpolation`          | string or None  | `None`    | Interpolation method for matplotlib image plots (when one or both of `axes` or `colorbar` is true). See [matplotlib imshow intepolations](https://matplotlib.org/stable/gallery/images_contours_and_fields/interpolation_methods.html).                                                                                                                         |
