...
|                 | `rolling_window_size`             | int            | `20.0`                   | The length (in nm) of the coordinate averaging window to smooth the ordered trace.                                                                                                                                                                                                                                                 |
|                 | `spline_step_size`                | int            | `7.0`                    | The The sampling length of the spline (in nm) to obtain an average of splines.                                                                                                                                                                                                                                                     |
