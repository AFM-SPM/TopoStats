...
class GrainStats:
    ...
    def get_triangle_height(base_point_1: np.array, base_point_2: np.array, top_point: np.array) -> float:
        ...
        Parameters
        ----------
        base_point_1 : npt.NDArray
            First base point of the triangle, eg: [5, 3].

        base_point_2 : npt.NDArray
            Second base point of the triangle, eg: [8, 3].

        top_point : npt.NDArray
            The apex of the triangle, defining the height from the line between the two base points, eg: [6,10].
    ...
    @staticmethod
    def get_max_min_ferets(edge_points: list) -> tuple[float, float]:  # noqa: C901
        """
        ...
        ----------
        edge_points : list
            List of the vector positions of the pixels comprising the edge of the grain. Eg: [[0, 0], [1, 0], [2, 1]].

        Returns
        -------
        tuple[float, float]
            The minimum and maximum feret of the grain.
