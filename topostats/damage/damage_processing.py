...
from topostats.damage.classes import Defect, Gap, OrderedDefectGapList
...
def calculate_defect_and_gap_turns(
    ...
    if circular:
        angles_radians = discrete_angle_difference_per_nm_circular(trace_points)
    else:
        angles_radians = discrete_angle_difference_per_nm_linear(trace_points)
