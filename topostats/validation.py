        ...
        "grains": {
            ...
            "vetting": {
                "class_conversion_size_thresholds": Or(
                    ...
                    [[[int, int, int], [int, int]]],
                    error="Invalid value in config for 'grains.vetting.class_conversion_size_thresholds', this "
                ...
                "class_region_number_thresholds": Or(
                    ...
                    [[int, int, int]],
                    error="Invalid value in config for 'grains.vetting.class_region_number_thresholds', this needs"
                ...
                "class_size_thresholds": Or(
                    ...
                    # List of lists of 3 integers
                    [[int, int, int]],
                    error="Invalid value in config for 'grains.vetting.class_size_thresholds', this needs to be a"
                ...
                "nearby_conversion_classes_to_convert": Or(
                    ...
                    [[int, int]],
                    error="Invalid value in config for 'grains.vetting.nearby_conversion_classes_to_convert', this"
                ...
                "keep_largest_labelled_regions_classes": Or(
                    ...
                    # List of integers
                    [int],
                    error="Invalid value in config for 'grains.vetting.keep_largest_labelled_regions_classes', this"
                ...
                "class_connection_point_thresholds": Or(
                    ...
                    [[[int, int], [int, int]]],
                    error="Invalid value in config for 'grains.vetting.class_connection_point_thresholds', this"
