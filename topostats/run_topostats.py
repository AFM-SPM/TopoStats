...
class TopoStatsWorkflow:
    """Template Class for TopoStats workflows"""
...
class DefaultWorkflow(TopoStatsWorkflow):
    """Default TopoStats workflow"""
...
def run_topostats_workflow(workflow: TopoStatsWorkflow, args=None):
