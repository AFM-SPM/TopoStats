...
from topostats import __version__, processing
...
def create_parser() -> arg.ArgumentParser:
    ...
    process_parser.add_argument(
        ...
        dest="grains_absolute_area_threshold-above",
        type=float,
        required=False,
        nargs=2,
    ...
    process_parser.add_argument(
        ...
        dest="grains_absolute_area_threshold-below",
        type=float,
        required=False,
        nargs=2,
    ...
    # Unet
    process_parser.add_argument(
        "--unet-model-path", dest="unet_mode_path", type=str, required=False, help="Path to a trained U-net model"
    )
    process_parser.add_argument(
    ...
    process_parser.add_argument(
        ...
        dest="grainstats_extract_heigh_profile",
        type=bool,
        required=False,
    ...
    process_parser.add_argument(
        ...
        dest="disordered_pruning_params_height-threshold",
        type=float,
        required=False,
    ...
    # Run the relevant function with the arguments
    load_parser.set_defaults(func=run_topostats)
    ...
    # Run the relevant function with the arguments
    filter_parser.set_defaults(func=processing.run_filters)
    ...
    grains_parser.add_argument(
        ...
        dest="absolute_area_threshold-above",
        type=float,
        required=False,
        nargs=2,
        help="Above surface (low, high) in nm^2, both low and high should be specified",
    ...
    grains_parser.add_argument(
        ...
        dest="absolute_area_threshold-below",
        type=float,
        required=False,
        nargs=2,
        help="Below surface (low, high) in nm^2, both low and high should be specified",
    ...
    # Run the relevant function with the arguments
    grains_parser.set_defaults(func=processing.run_grains)
    ...
    grainstats_parser.add_argument(
        ...
        dest="extract_heigh_profile",
        type=bool,
        required=False,
        help="Extract height profiles along maximum feret of molecules",
    )
    # Run the relevant function with the arguments
    grainstats_parser.set_defaults(func=processing.run_grainstats)

    # Disordered
    disordered_tracing_parser = subparsers.add_parser(
        "disordered-tracing",
        description="Skeletonise and prune objects to disordered traces.",
        help="Skeletonise and prune objects to disordered traces.",
    )
    ...
    disordered_tracing_parser.add_argument(
        ...
        dest="pruning_params_height-threshold",
        type=float,
        required=False,
        help="The height to remove branches below",
    )
    ...
    # Run the relevant function with the arguments
    disordered_tracing_parser.set_defaults(func=processing.run_disordered_tracing)

    # Nodestats
    nodestats_parser = subparsers.add_parser(
        "nodestats",
        description="Calculate node statistics and disentangle molecules.",
        help="Calculate node statistics and disentangle molecules.",
    )
    ...
    # Run the relevant function with the arguments
    nodestats_parser.set_defaults(func=processing.run_nodestats)

    # Ordered Tracing
    ordered_tracing_parser = subparsers.add_parser(
        "ordered-tracing",
        description="Ordered traces of pruned skeletons.",
        help="Ordered traces of pruned skeletons.",
    )
    ...
    # Run the relevant function with the arguments
    ordered_tracing_parser.set_defaults(func=processing.run_ordered_tracing)

    # Splining
    splining_parser = subparsers.add_parser(
        "splining",
        description="Splining of traced molecules to produce smooth curves.",
        help="Splining of traced molecules to produce smooth curves.",
    )
    ...
    # Run the relevant function with the arguments
    splining_parser.set_defaults(func=processing.run_splining)
